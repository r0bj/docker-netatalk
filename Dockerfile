...
RUN apt-get update \
 && apt-get install \
        ...
        avahi-daemon \
        curl wget \
          &&  wget      "https://netix.dl.sourceforge.net/project/netatalk/netatalk/3.1.11/netatalk-3.1.11.tar.gz" \
          &&  curl -SL  "https://netix.dl.sourceforge.net/project/netatalk/netatalk/3.1.11/netatalk-3.1.11.tar.gz" | tar xvz
